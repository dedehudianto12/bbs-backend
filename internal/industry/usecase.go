...
func (u *Usecase) ListAdmin(ctx context.Context, search, sort string, page, limit int) ([]Industry, int, error) {
...
func (u *Usecase) Create(ctx context.Context, ind *Industry) error {
	...
	ind.Slug = util.Slugify(ind.Name)
...
func (u *Usecase) Update(ctx context.Context, id string, ind *Industry) (*Industry, error) {
	...
	if ind.Name != "" {
		...
		existing.Slug = util.Slugify(ind.Name)
	}
	if ind.Description != "" {
